...
export default function Header() {
  ...
  return (
    <div className='fixed z-9 top-0 inset-x-0 h-15 md:h-20 shadow-2xs md:pl-70 md:group-[.menuSmall]:pl-20 transition-all duration-300'>
      <div className='flex justify-between items-center px-3 md:px-5 h-full'>
